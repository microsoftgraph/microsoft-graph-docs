...
[OneDrive API]: https://developer.microsoft.com/graph/do(/graph/api/resources/onedrive?view=graph-rest-1.0)
...
[SharePoint]: https://developer.microsoft.com/graph/do(/graph/api/resources/sharepoint?view=graph-rest-1.0)
