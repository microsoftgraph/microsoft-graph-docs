...
|Change type|Version|Description|
|:---|:---|:---|
|Addition|v1.0|Added the **edgeSendIntranetTrafficToInternetExplorer** property to the [windows10GeneralConfiguration](/graph/api/resources/intune-deviceconfig-windows10generalconfiguration?view=graph-rest-v1.0) entity|
