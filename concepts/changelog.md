...
|Change type|Version|Description|
|:---|:---|:---|
|Addition|beta|Added new entities:<br/>[intuneBrandingProfileAssignment](../api-reference/beta/resources/intune_wip_intunebrandingprofileassignment.md)<br/>[macOsVppApp](../api-reference/beta/resources/intune_apps_macosvppapp.md)<br/>[macOsVppAppAssignedLicense](../api-reference/beta/resources/intune_apps_macosvppappassignedlicense.md)<br/>[windowsDeliveryOptimizationConfiguration](../api-reference/beta/resources/intune_deviceconfig_windowsdeliveryoptimizationconfiguration.md)<br/>|
|Addition|beta|Added new complex types:<br/>[androidEnrollmentCompanyCode](../api-reference/beta/resources/intune_androidforwork_androidenrollmentcompanycode.md)<br/>[deviceAndAppManagementAssignedRoleDetails](../api-reference/beta/resources/intune_rbac_deviceandappmanagementassignedroledetails.md)<br/>[edgeHomeButtonConfiguration](../api-reference/beta/resources/intune_deviceconfig_edgehomebuttonconfiguration.md)<br/>[edgeHomeButtonHidden](../api-reference/beta/resources/intune_deviceconfig_edgehomebuttonhidden.md)<br/>[edgeHomeButtonLoadsStartPage](../api-reference/beta/resources/intune_deviceconfig_edgehomebuttonloadsstartpage.md)<br/>[edgeHomeButtonOpensCustomURL](../api-reference/beta/resources/intune_deviceconfig_edgehomebuttonopenscustomurl.md)<br/>[edgeHomeButtonOpensNewTab](../api-reference/beta/resources/intune_deviceconfig_edgehomebuttonopensnewtab.md)<br/>[macOsVppAppRevokeLicensesActionResult](../api-reference/beta/resources/intune_apps_macosvppapprevokelicensesactionresult.md)<br/>|
|Addition|beta|Added new enum types:<br/>[browserSyncSetting](../api-reference/beta/resources/intune_deviceconfig_browsersyncsetting.md)<br/>[edgeOpenOptions](../api-reference/beta/resources/intune_deviceconfig_edgeopenoptions.md)<br/>[edgeTelemetryMode](../api-reference/beta/resources/intune_deviceconfig_edgetelemetrymode.md)<br/>[internetExplorerMessageSetting](../api-reference/beta/resources/intune_deviceconfig_internetexplorermessagesetting.md)<br/>[windowsKioskAppType](../api-reference/beta/resources/intune_deviceconfig_windowskioskapptype.md)<br/>|
|Addition|beta|Added the [setAndroidDeviceOwnerFullyManagedEnrollmentState](../api/intune_androidforwork_androidmanagedstoreaccountenterprisesettings_setandroiddeviceownerfullymanagedenrollmentstate.md) action on [androidManagedStoreAccountEnterpriseSettings](../api-reference/beta/resources/intune_androidforwork_androidmanagedstoreaccountenterprisesettings.md) |
|Addition|beta|Added the **refreshDeviceComplianceReportSummarization** action on [deviceCompliancePolicy](../api-reference/beta/resources/intune_deviceconfig_devicecompliancepolicy.md) collection |
|Addition|beta|Added the [assign](../api/intune_wip_intunebrandingprofile_assign.md) action on [intuneBrandingProfile](../api-reference/beta/resources/intune_wip_intunebrandingprofile.md) |
|Addition|beta|Added the [getAssignedRoleDetails](../api/intune_rbac_devicemanagement_getassignedroledetails.md) function on [deviceManagement](../api-reference/beta/resources/intune_androidforwork_devicemanagement.md) |
|Addition|beta|Added the [scopedForResource](../api/intune_rbac_devicemanagement_scopedforresource.md) function on [deviceManagement](../api-reference/beta/resources/intune_androidforwork_devicemanagement.md) |
|Deletion|beta|Removed the following complex types:<br/>**deviceAndAppManagementAssignedRoleIds**<br/>|
|Deletion|beta|Removed the [getAssignedRoleIdsForLoggedInUser](../api/intune_rbac_devicemanagement_getassignedroleidsforloggedinuser.md) function on [deviceManagement](../api-reference/beta/resources/intune_androidforwork_devicemanagement.md) |
|Addition|beta|Added the **kioskModeWallpaperUrl**, **kioskModeExitCode** and **kioskModeVirtualHomeButtonEnabled** properties to the [androidDeviceOwnerGeneralDeviceConfiguration](../api-reference/beta/resources/intune_deviceconfig_androiddeviceownergeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **patchVersion** property to the [androidManagedAppRegistration](../api-reference/beta/resources/intune_mam_androidmanagedappregistration.md) entity|
|Addition|beta|Added the **companyCodes** and **androidDeviceOwnerFullyManagedEnrollmentEnabled** properties to the [androidManagedStoreAccountEnterpriseSettings](../api-reference/beta/resources/intune_androidforwork_androidmanagedstoreaccountenterprisesettings.md) entity|
|Addition|beta|Added the **deviceComplianceReportSummarizationDateTime** properties to the [deviceManagement](../api-reference/beta/resources/intune_androidforwork_devicemanagement.md) entity|
|Addition|beta|Added the **osMinimumBuildVersion** and **osMaximumBuildVersion** properties to the [iosCompliancePolicy](../api-reference/beta/resources/intune_deviceconfig_ioscompliancepolicy.md) entity|
|Addition|beta|Added the **smimeEncryptByDefaultEnabled**, **smimeSigningEnabled**, **smimeSigningUserOverrideEnabled**, **smimeEncryptByDefaultUserOverrideEnabled**, **smimeSigningCertificateUserOverrideEnabled** and **smimeEncryptionCertificateUserOverrideEnabled** properties to the [iosEasEmailProfileConfiguration](../api-reference/beta/resources/intune_deviceconfig_ioseasemailprofileconfiguration.md) entity|
|Addition|beta|Added the **appRemovalBlocked**, **usbRestrictedModeBlocked**, **passwordBlockAutoFill**, **passwordBlockProximityRequests**, **passwordBlockAirDropSharing** and **dateAndTimeForceSetAutomatically** properties to the [iosGeneralDeviceConfiguration](../api-reference/beta/resources/intune_deviceconfig_iosgeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **roleScopeTagIds** property to the [iosVppEBook](../api-reference/beta/resources/intune_books_iosvppebook.md) entity|
|Addition|beta|Added the **osMinimumBuildVersion** and **osMaximumBuildVersion** properties to the [macOSCompliancePolicy](../api-reference/beta/resources/intune_deviceconfig_macoscompliancepolicy.md) entity|
|Addition|beta|Added the **passwordBlockAutoFill**, **passwordBlockProximityRequests** and **passwordBlockAirDropSharing** properties to the [macOSGeneralDeviceConfiguration](../api-reference/beta/resources/intune_deviceconfig_macosgeneraldeviceconfiguration.md) entity|
|Addition|beta|Added the **isAssigned** property to the [mobileApp](../api-reference/beta/resources/intune_apps_mobileapp.md) entity|
|Addition|beta|Added the **roleScopeTagIds** property to the [roleDefinition](../api-reference/beta/resources/intune_rbac_roledefinition.md) entity|
|Addition|beta|Added the **roleScopeTagIds** property to the [vppToken](../api-reference/beta/resources/intune_onboarding_vpptoken.md) entity|
...
|Deletion|beta|Removed the **authenticationAllowFIDODevice** property from the [windows10GeneralConfiguration](../api-reference/beta/resources/intune_deviceconfig_windows10generalconfiguration.md) entity|
|Change|beta|Changed the following properties on the [windowsIdentityProtectionConfiguration](../api-reference/beta/resources/intune_deviceconfig_windowsidentityprotectionconfiguration.md) entity:<br/>**windowsHelloForBusinessBlocked** from required to optional<br/>|
|Deletion|beta|Removed the **qualityUpdatesPauseStartDateTime** and **featureUpdatesPauseStartDateTime** properties from the [windowsUpdateForBusinessConfiguration](../api-reference/beta/resources/intune_deviceconfig_windowsupdateforbusinessconfiguration.md) entity|
|Addition|beta|Added the **assignments** navigation property to the [intuneBrandingProfile](../api-reference/beta/resources/intune_wip_intunebrandingprofile.md) entity|
|Addition|beta|Added the **appType** property to the [windowsKioskAppBase](../api-reference/beta/resources/intune_deviceconfig_windowskioskappbase.md) complex type|
|Addition|beta|Added the **windows10Home**, **windows10HomeChina**, **windows10HomeN**, **windows10HomeSingleLanguage**, **windows10Mobile**, **windows10IoTCore** and **windows10IoTCoreCommercial** members to the [windows10EditionType](../api-reference/beta/resources/intune_deviceconfig_windows10editiontype.md) enum type|
