...
| Change          | Beta        | Changed the following properties on the [getMobileAppCount](../do(/graph/api/intune_apps_mobileapp_getmobileappcount?view=graph-rest-beta) entity:<br/>**bindingParameter** from **mobileApp** to a **collection** of *mobileApp*<br/>**status** from a GUID to a String<br/> |
