...
| Chagne | beta | Changed the **provisioningTaskIdentifier** property to id on the [synchronizationSchema](/graph/api-reference/beta/resources/synchronization-synchronizationschema.md) resource. |
