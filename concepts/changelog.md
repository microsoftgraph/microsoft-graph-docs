...
| Change | beta | Changed the **provisioningTaskIdentifier** property to id on the [synchronizationSchema](/api-reference/beta/resources/synchronization-synchronizationschema.md) resource. |
