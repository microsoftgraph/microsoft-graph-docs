...
See an [example of the other way to assign **id** in the request](/graph/api/schemaextension_post_schemaextensions?view=graph-rest-1.0), that requires you to provide only a schema name.
