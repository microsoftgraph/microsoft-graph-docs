...
The two calls to **findMeetingTimes** include the following parameters. All [parameters](/graph/api/user-findmeetingtimes?view=graph-rest-1.0) for **findMeetingTimes** are optional.
...
[confidence of a meeting suggestion](/graph/api/user-findmeetingtimes?view=graph-rest-1.0)
and other [parameters](/graph/api/user-findmeetingtimes?view=graph-rest-1.0), and apply them as appropriate for meetings of larger sizes.
