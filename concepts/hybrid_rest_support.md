...
[Calendar](https://developer.microsoft.com/https://developer.microsoft.com/graph/graph/docs/api-reference/v1.0/resources/calendar), or 
[Contacts](https://developer.microsoft.com/https://developer.microsoft.com/graph/graph/docs/api-reference/v1.0/resources/contact) API, you will now also find a seamless 
...
such as the [Groups](https://developer.microsoft.com/https://developer.microsoft.com/graph/graph/docs/api-reference/v1.0/resources/group) API, or APIs in other versions, 
