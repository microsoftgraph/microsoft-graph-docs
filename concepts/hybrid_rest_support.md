...
[Mail](https://developer.microsoft.com/graph/do(/graph/api/resources/message?view=graph-rest-1.0), 
[Calendar](https://developer.microsoft.com/graph/do(/graph/api/resources/calendar?view=graph-rest-1.0), or 
[Contacts](https://developer.microsoft.com/graph/do(/graph/api/resources/contact?view=graph-rest-1.0) API, you will now also find a seamless 
...
such as the [Groups](https://developer.microsoft.com/graph/do(/graph/api/resources/group?view=graph-rest-1.0) API, or APIs in other versions, 
