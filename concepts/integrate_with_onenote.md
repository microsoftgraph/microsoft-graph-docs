...
<!-- Might be good to show a few examples of Microsoft Graph API calls here, similar to what we have in the featured scenarios topic: https://developer.microsoft.com/graph/do(featured_scenarios..md) You could have an H2 section called "What can I do with OneNote APIs in Microsoft Graph?"-->
