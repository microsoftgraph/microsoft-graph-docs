...
When you perform a [GET operation to retrieve a chart image(/graph/api/chart_image?view=graph-rest-1.0), the Excel API returns the image as a base-64 string.
...
![Excel chart image with default height and width.](https://cdn.graph.office.net/prod/GraphDocuments/en-(images/GetChart-default.png)
