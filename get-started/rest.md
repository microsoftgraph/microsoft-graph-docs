...
| scope | A space-separated list of [Microsoft Graph permissions](../authorization/permission_scopes.md) that the app is requesting. You can also specify [OpenId Connect scopes](https://azure.microsoft.com/en-us/documentation/articles/active-directory-v2-scopes/#openid-connect-scopes) for [single sign-on](https://azure.microsoft.com/en-us/documentation/articles/active-directory-v2-protocols-oidc/).  |
...
| scope | A space-separated list of [Microsoft Graph permissions](../authorization/permission_scopes.md) that the app is requesting. |
