...
```http
GET /reports/YammerDeviceUsageUserDetail(period='{period_value}')
GET /reports/YammerDeviceUsageUserDetail(date={date_value})
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_yammerdeviceusageuserdetail"
}-->
