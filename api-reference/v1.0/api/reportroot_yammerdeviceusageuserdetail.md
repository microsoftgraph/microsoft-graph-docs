...
```http
GET /reports/YammerDeviceUsageUserDetail(period='D7')
GET /reports/YammerDeviceUsageUserDetail(date='2017-09-01')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/YammerDeviceUsageUserDetail(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.yammerDeviceUsageUserDetail)", 
  "value": [
    {
