...
```http
GET /reports/YammerGroupsActivityUserDetail(period='D7')
GET /reports/YammerGroupsActivityUserDetail(date='2017-09-01')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/YammerGroupsActivityUserDetail(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.yammerGroupsActivityUserDetail)", 
  "value": [
    {
