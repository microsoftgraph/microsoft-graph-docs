...
```http
GET /reports/SharePointActivityUserDetail(period='{period_value}')
GET /reports/SharePointActivityUserDetail(date={date_value})
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_sharepointactivityuserdetail"
}-->
