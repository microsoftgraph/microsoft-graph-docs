# Get SharePointActivityUserDetail report
...
```http
GET /reports/SharePointActivityUserDetail(period='D7')
GET /reports/SharePointActivityUserDetail(date='2017-09-01')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/SharePointActivityUserDetail(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.sharePointActivityUserDetail)", 
  "value": [
    {
