...
```http
GET /reports/EmailAppUsageUserCounts(period='D7')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/EmailAppUsageUserCounts(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.emailAppUsageUserCounts)", 
  "value": [
    {
