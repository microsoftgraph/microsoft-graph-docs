...
```http
GET /reports/OneDriveActivityUserDetail(period='D7')
GET /reports/OneDriveActivityUserDetail(date='2017-09-01')
```
...
If successful, this method returns a `200 OK` response code and an **oneDriveActivityUserDetail** object in the response body.

The **oneDriveActivityUserDetail** object has the following properties.
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.oneDriveActivityUserDetail)", 
  "value": [
    {
