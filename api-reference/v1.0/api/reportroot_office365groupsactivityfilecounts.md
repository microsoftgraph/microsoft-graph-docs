...
```http
GET /reports/Office365GroupsActivityFileCounts(period='{period_value}')
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_office365groupsactivityfilecounts"
}-->

```http
GET https://graph.microsoft.com/v1.0/reports/Office365GroupsActivityFileCounts(period='D7')
```
