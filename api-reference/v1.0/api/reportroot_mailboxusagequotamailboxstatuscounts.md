...
```http
GET https://graph.microsoft.com/v1.0/reports/MailboxUsageQuotaMailboxStatusCounts(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.mailboxUsageQuotaMailboxStatusCounts)", 
  "value": [
    {
