...
```http
GET /reports/SkypeForBusinessActivityUserCounts(period='{period_value}')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/SkypeForBusinessActivityUserCounts(period='D7')
```
