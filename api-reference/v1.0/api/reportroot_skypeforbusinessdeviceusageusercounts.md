# reportRoot: SkypeForBusinessDeviceUsageUserCounts function
...
```http
GET /reports/SkypeForBusinessDeviceUsageUserCounts(period='{period_value}')
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_skypeforbusinessdeviceusageusercounts"
}-->

```http
GET https://graph.microsoft.com/v1.0/reports/SkypeForBusinessDeviceUsageUserCounts(period='D7')
```
