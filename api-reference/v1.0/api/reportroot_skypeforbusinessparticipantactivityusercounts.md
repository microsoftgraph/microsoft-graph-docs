# reportRoot: SkypeForBusinessParticipantActivityUserCounts function
...
```http
GET /reports/SkypeForBusinessParticipantActivityUserCounts(period='{period_value}')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/SkypeForBusinessParticipantActivityUserCounts(period='D7')
```
