# Get OneDriveUsageUserDetail report

Get an OneDrive usage user detail report.
...
```http
GET /reports/OneDriveUsageUserDetail(period='D7')
GET /reports/OneDriveUsageUserDetail(date='2017-09-01')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.oneDriveUsageUserDetail)", 
  "value": [
    {
