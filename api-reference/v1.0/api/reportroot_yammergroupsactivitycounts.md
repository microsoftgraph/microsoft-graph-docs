...
```http
GET /reports/YammerGroupsActivityCounts(period='D7')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/YammerGroupsActivityCounts(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.yammerGroupsActivityCounts)", 
  "value": [
    {
