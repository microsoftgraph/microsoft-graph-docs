# Get OneDriveUsageFileCounts report

Get an OneDrive usage file counts report.
...
```http
GET /reports/OneDriveUsageFileCounts(period='D7')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/OneDriveUsageFileCounts(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.oneDriveUsageFileCounts)", 
  "value": [
    {
