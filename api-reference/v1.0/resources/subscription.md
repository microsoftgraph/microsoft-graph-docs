...
- A [printer][] when a print job for the printer gets to JobFetchable state - ready to be fetched for printing (For more information, see [Subscribe to change notifications from cloud printing APIs](../../../concepts/universal-print-webhook-notifications.md))
- A [printTaskDefinition][] in Print Service (For more information, see  [Subscribe to change notifications from cloud printing APIs](../../../concepts/universal-print-webhook-notifications.md))
