...
|isAssignableToRole|Boolean|Indicates if this group can be assigned to Azure AD role or not. <br><br>This property can only be set while creating the group and is immutable. Only Global Admin and Privileged Role Administrator can set this property. For more information, see this - [Using a group to manage Azure AD role assignments](https://go.microsoft.com/fwlink/?linkid=2103037)<br><br>Returned by default.|
