...
|edgeCookiePolicy|edgeCookiePolicy|Indicates which cookies to block in the Microsoft Edge browser. The possible values are: `userDefined`, `allow`, `blockThirdParty`, `blockAll`.|
