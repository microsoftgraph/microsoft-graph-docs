...
Represents an Azure Active Directory tenant. Only the read operations are supported on tenants; create, update and delete are not supported. Inherits from [directoryObject](directoryobject.md).
