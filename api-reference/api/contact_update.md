...
|phones|[Phone](../resources/phone.md) collection|The contact's phone numbers.|
|postalAddresses|[PhysicalAddress](../resources/physicaladdress.md) collection|The contact's addresses.|
|profession|String|The contact's profession.|
|spouseName|String|The name of the contact's spouse.|
|surname|String|The contact's surname.|
|title|String|The contact's title.|
|websites|[Website](../resources/website.md) collection|The contact's websites.|
