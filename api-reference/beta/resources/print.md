...
| [Create printerShare](../api/print-post-printershares.md) | [printerShare](printershare.md) | Create a new printer share by posting to the **shares** collection. |
...
|printerShares|[printerShare](printershare.md)|The list of printer shares registered in the tenant.|
