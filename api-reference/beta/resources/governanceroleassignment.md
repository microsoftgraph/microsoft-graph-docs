...
|endDateTime|DateTimeOffset|It represents the date time when the role assignment will be expired. If the role assignment is permanent, the value would be `null`. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 would look like this: `'2014-01-01T00:00:00Z'`|
