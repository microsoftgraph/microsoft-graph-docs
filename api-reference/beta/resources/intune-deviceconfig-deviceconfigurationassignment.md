...
|target|[deviceAndAppManagementAssignmentTarget](../resources/intune-deviceconfig-deviceandappmanagementassignmenttarget.md)|The assignment target for the device configuration.|
