...
|[Update outcome](../api/educationsubmission-update-outcome.md) |[educationOutcome](educationOutcome.md)| Update an **educationOutcome** object.|
...
|:---------------|:--------|:----------|
|outcomes|[educationOutcome](educationoutcome.md) collection| Nullable.|
