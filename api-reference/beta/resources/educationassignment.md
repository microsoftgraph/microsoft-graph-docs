...
|[Set up resources folder](../api/educationassignment-setupresourcesfolder.md)| string| The OneDrive folder into which file-based resources should be placed to be part of an assignment resource.|
...
```json
{
  ...
  "addToCalendarAction": "microsoft.education.assignments.api.educationAddToCalendarAction",
