...
| id                      | String                                                                                                 |                                                                                                                                                                                                     |
| mediaConfig             | [ApplicationMediaConfig](apphostedMediaConfig.md) or [serviceHostedMediaConfig](serviceHostedMediaConfig.md) | The media configuration.                                                                                                                                                                            |
...
```json
{
  ...
  "answeredBy": {"@odata.type": "microsoft.graph.identitySet"},
