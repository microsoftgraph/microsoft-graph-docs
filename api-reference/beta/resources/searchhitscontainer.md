...
|total|Int32|The estimated total number of results satisfying the query. Note this is not the number of results on the page, but the total number of results satisfying the query.|
