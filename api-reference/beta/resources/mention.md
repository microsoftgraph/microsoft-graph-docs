...
|:---------------|:--------|:----------|
|[Post](../api/user_sendmail.md#request-2) | None | Create and send mentions as part of a new message.| 
|[Post](../api/user_post_messages.md#request-2) | [message](../resources/message.md) that contains one or more **mention** objects. | Create a draft of a new message and include one or more **mention** objects.| 
|[Get](../api/user_list_messages.md#request-2) | [message](../resources/message.md) collection | Get all the messages in the signed-in user's mailbox that contain a **mention** of this user.|
|[Get](../api/message_get.md#request-2) | [message](../resources/message.md) collection | Get a message and expand the details of each **mention** in the message.|
|[Delete](../api/message_delete.md#request-2) | None |Deletes the specified mention in the specified message in the signed-in user's mailbox. |
