...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitycounts_json-snippets.md)]
<!--
{
