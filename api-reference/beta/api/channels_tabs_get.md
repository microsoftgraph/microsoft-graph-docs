...
Retrieve the properties and relationships of the specified [tab](../resources/teamschanneltab.md). 
...
If successful, this method returns a `200 OK` response code and [tab](../resources/teamschanneltab.md) object in the response body.
## Example
#### Request
