...
-->
```http
PATCH /deviceManagement/notificationMessageTemplates/<id>/localizedNotificationMessages/<id>
PATCH /localizedNotificationMessages/<id>
```
...
```http
PATCH https://graph.microsoft.com/beta/deviceManagement/notificationMessageTemplates/<id>/localizedNotificationMessages/<id>
