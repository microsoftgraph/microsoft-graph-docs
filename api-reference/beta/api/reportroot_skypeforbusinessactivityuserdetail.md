...
```http
GET /reports/SkypeForBusinessActivityUserDetail(period='D7')?$format=application/json
GET /reports/SkypeForBusinessActivityUserDetail(date=2017-09-01)?$format=application/json
```
