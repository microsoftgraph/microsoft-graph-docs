...
```
[!include[Example Code]( ../includes/get_event-snippets.md)]
...
```
[!include[Example Code]( ../includes/get_event_in_text-snippets.md)]
...
```
[!include[Example Code]( ../includes/get_event_multiple_locations-snippets.md)]
