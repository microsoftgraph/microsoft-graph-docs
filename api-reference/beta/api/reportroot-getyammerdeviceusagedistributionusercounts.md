...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusagedistributionusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusagedistributionusercounts_json-snippets.md)]
<!--
{
