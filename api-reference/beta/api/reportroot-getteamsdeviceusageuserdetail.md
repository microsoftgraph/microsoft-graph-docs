...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusageuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusageuserdetail_json-snippets.md)]
<!--
{
