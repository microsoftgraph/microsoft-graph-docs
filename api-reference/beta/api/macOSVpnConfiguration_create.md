...
Create a new [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `201 Created` response code and a [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md) object in the response body.
