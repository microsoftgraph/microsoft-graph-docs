...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitygroupcounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitygroupcounts_json-snippets.md)]
<!--
{
