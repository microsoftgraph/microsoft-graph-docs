# reportRoot: OneDriveActivityUserDetail function
...
<!-- {
  "blockType": "request",
  "name": "reportroot_onedriveactivityuserdetail"
}-->

```http
GET https://graph.microsoft.com/beta/reports/OneDriveActivityUserDetail(period='D7')?$format=application/json
```
