...
Read properties and relationships of the [deviceComplianceActionItem](../resource/deviceComplianceActionItem.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [deviceComplianceActionItem](../resource/deviceComplianceActionItem.md) object in the response body.
