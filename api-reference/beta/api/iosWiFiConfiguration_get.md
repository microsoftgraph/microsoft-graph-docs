...
Read properties and relationships of the [iosWiFiConfiguration](../resources/iosWiFiConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosWiFiConfiguration](../resources/iosWiFiConfiguration.md) object in the response body.
