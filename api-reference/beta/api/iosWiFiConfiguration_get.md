...
Read properties and relationships of the [iosWiFiConfiguration](../resource/iosWiFiConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosWiFiConfiguration](../resource/iosWiFiConfiguration.md) object in the response body.
