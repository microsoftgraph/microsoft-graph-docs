...
Read properties and relationships of the [iosScepCertificateProfile](../resource/iosScepCertificateProfile.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosScepCertificateProfile](../resource/iosScepCertificateProfile.md) object in the response body.
