...
Read properties and relationships of the [iosEnterpriseWiFiConfiguration](../resource/iosEnterpriseWiFiConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosEnterpriseWiFiConfiguration](../resource/iosEnterpriseWiFiConfiguration.md) object in the response body.
