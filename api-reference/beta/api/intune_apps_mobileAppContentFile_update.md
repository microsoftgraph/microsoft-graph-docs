...
-->
```http
PATCH ** Entity URI for microsoft.management.services.api.mobileAppContentFile not found
```
...
```http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.mobileAppContentFile not found
