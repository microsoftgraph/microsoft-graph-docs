...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusageusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusageusercounts_json-snippets.md)]
<!--
{
