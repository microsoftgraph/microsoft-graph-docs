...
This API allows you to receive near-real-time change notifications for a [drive][] using [socket.io][].
Socket.io is a popular notifications library for javascript, utilizing WebSockets.
Learn more about socket.io at https://socket.io.
...
Here is an example of using the notificationUrl with socket.io in javascript:
