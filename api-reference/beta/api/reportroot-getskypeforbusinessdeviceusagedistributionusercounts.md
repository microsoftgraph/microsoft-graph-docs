...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessdeviceusagedistributionusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessdeviceusagedistributionusercounts_json-snippets.md)]
<!--
{
