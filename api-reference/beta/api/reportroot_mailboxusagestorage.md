...
If successful, this method returns a `200 OK` response code and a **mailboxUsageStorage** object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_mailboxusagestorage"
}-->

```http
GET https://graph.microsoft.com/beta/reports/MailboxUsageStorage(period='D7')?$format=application/json
```
