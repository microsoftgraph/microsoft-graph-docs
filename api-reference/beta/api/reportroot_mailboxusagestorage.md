...
```http
GET /reports/MailboxUsageStorage(period='D7')
```
...
If successful, this method returns a `200 OK` response code and an **mailboxUsageStorage** object in the response body.

The **mailboxUsageStorage** object has the following properties.
...
```http
GET https://graph.microsoft.com/v1.0/reports/MailboxUsageStorage(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.mailboxUsageStorage)", 
  "value": [
    {
