...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivityuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivityuserdetail_json-snippets.md)]
<!--
{
