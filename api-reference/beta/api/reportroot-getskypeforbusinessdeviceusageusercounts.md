...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessdeviceusageusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessdeviceusageusercounts_json-snippets.md)]
<!--
{
