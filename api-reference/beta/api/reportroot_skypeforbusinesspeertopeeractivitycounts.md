...
```http
GET /reports/SkypeForBusinessPeerToPeerActivityCounts(period='{period_value}')?$format=application/json
```
...
If successful, this method returns a `200 OK` response code and a **skypeForBusinessPeerToPeerActivityCounts** object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_skypeforbusinesspeertopeeractivitycounts"
}-->
