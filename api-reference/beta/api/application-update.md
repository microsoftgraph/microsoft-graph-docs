...
| onPremisesPublishing | [onPremisesPublishing](../resources/onpremisespublishing.md) | Represents the set of properties for configuring [Azured AD Application Proxy](https://aka.ms/whyappproxy) for an on-premises application. After creating an application, set the properties for onPremisesPublishing to configure Application Proxy for the application. |
