...
Read properties and relationships of the [cloudPkiSubscription](../resources/cloudPkiSubscription.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [cloudPkiSubscription](../resources/cloudPkiSubscription.md) object in the response body.
