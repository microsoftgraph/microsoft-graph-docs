...
Read properties and relationships of the [cloudPkiSubscription](../resource/cloudPkiSubscription.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [cloudPkiSubscription](../resource/cloudPkiSubscription.md) object in the response body.
