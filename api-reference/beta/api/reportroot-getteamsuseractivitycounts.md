...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivitycounts_json-snippets.md)]
<!--
{
