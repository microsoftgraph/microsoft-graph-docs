...
Read properties and relationships of the [iosEasEmailProfileConfiguration](../resource/iosEasEmailProfileConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosEasEmailProfileConfiguration](../resource/iosEasEmailProfileConfiguration.md) object in the response body.
