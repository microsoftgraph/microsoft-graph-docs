...
### Request body
In the request body, supply a JSON representation of a [windows81SCEPCertificateProfile](../resources/windows81SCEPCertificateProfile.md) object.
The following table shows the properties that are required when you create a [windows81SCEPCertificateProfile](../resources/windows81SCEPCertificateProfile.md).
