...
### Request body
In the request body, supply a JSON representation of a [macOSVpnConfiguration](../resources/macOSVpnConfiguration.md) object.
The following table shows the properties that are required when you create a [macOSVpnConfiguration](../resources/macOSVpnConfiguration.md).
