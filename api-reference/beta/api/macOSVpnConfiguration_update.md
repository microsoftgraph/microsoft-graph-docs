...
Update the properties of a [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md) object.
### Prerequisites
...
### Request body
In the request body, supply a JSON representation of a [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md) object.
The following table shows the properties that are required when you create a [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md).
...
### Response
If successful, this method returns a `200 OK` response code and an updated [macOSVpnConfiguration](../resource/macOSVpnConfiguration.md) object in the response body.
