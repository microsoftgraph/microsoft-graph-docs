# Get SharePointSiteUsageUserDetail report
...
```http
GET /reports/SharePointSiteUsageUserDetail(period='D7')?$format=application/json
GET /reports/SharePointSiteUsageUserDetail(date=2017-09-01)?$format=application/json
```
