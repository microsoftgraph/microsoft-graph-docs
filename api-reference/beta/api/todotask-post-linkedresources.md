...
You can also create a **linkedResource** object while [creating a todoTask](./todotasklist-post-tasks.md?preserve-view=true&tabs=http&view=graph-rest-beta#examples).
