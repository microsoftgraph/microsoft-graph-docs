...
```http
POST /financials/companies/{id}/items/{id}/picture
```
...
<!-- {
  "blockType": "request",
  "name": "create_picture_from_item"
}-->

```http
POST https://graph.microsoft.com/beta/financials/companies/{id}/items/{id}/picture
