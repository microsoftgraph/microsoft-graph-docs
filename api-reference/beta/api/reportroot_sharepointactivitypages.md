...
```http
GET /reports/SharePointActivityPages(period='D7')?$format=application/json
```
...
```http
GET https://graph.microsoft.com/beta/reports/SharePointActivityPages(period='D7')?$format=application/json
```
