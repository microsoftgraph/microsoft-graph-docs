...
## Response
If successful, this function returns a `200 OK` response code and a [vppTokenLicenseSummary](../resources/intune_onboarding_vpptokenlicensesummary.md) collection in the response body.
