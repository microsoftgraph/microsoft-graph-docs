...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivityuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivityuserdetail_json-snippets.md)]
<!--
{
