...
Get the total number of groups that existed, and how many performed group conversation activity.
...
```http
GET /reports/YammerGroupsActivityGroupCounts(period='{period_value}')?$format=application/json
```
