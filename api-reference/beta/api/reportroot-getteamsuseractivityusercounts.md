...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivityusercounts_json-snippets.md)]
<!--
{
