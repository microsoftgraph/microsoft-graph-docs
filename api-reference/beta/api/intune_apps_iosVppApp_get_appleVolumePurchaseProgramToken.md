...
-->
```http
GET ** Entity URI for microsoft.management.services.api.appleVolumePurchaseProgramToken not found
```
...
```http
GET https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.appleVolumePurchaseProgramToken not found
```
