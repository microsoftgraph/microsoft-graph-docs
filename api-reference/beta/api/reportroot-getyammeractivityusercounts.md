...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivityusercounts_json-snippets.md)]
<!--
{
