# reportRoot: SkypeForBusinessParticipantActivityCounts function
...
```http
GET /reports/SkypeForBusinessParticipantActivityCounts(period='{period_value}')?$format=application/json
```
...
If successful, this method returns a `200 OK` response code and a **skypeForBusinessParticipantActivityCounts** object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_skypeforbusinessparticipantactivitycounts"
}-->

```http
GET https://graph.microsoft.com/beta/reports/SkypeForBusinessParticipantActivityCounts(period='D7')?$format=application/json
```
