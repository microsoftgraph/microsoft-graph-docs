...
```http
GET /reports/OneDriveActivityUserCounts(period='{period_value}')?$format=application/json
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_onedriveactivityusercounts"
}-->

```http
GET https://graph.microsoft.com/beta/reports/OneDriveActivityUserCounts(period='D7')?$format=application/json
```
