...
## HTTP request
```
DELETE /financials/companies('{id}')/salesQuotes('{id}')/salesQuoteLines('{salesQuoteLineId}')
```
...
```json
DELETE https://graph.microsoft.com/beta/financials/companies('{id}')/salesQuotes('{id}')/salesQuoteLines('{salesQouteLineId}')
```
