...
Read the properties of the [settings](../resources/settings.md) object.
...
If successful, this method returns a `200 OK` response code and [settings](../resources/settings.md) object in the response body.
