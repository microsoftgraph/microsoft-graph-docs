...
```
[!include[Example Code]( ../includes/api-referencebetaapiprivilegedoperationevent-listmd#0-snippets.md)]
...
```
[!include[Example Code]( ../includes/api-referencebetaapiprivilegedoperationevent-listmd#1-snippets.md)]
...
```
[!include[Example Code]( ../includes/api-referencebetaapiprivilegedoperationevent-listmd#2-snippets.md)]
...
```
[!include[Example Code]( ../includes/api-referencebetaapiprivilegedoperationevent-listmd#3-snippets.md)]
