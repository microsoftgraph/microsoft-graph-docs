...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityuserdetail_json-snippets.md)]
<!--
{
