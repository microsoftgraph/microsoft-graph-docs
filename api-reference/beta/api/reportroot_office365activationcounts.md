...
```http
GET /reports/Office365ActivationCounts?$format=application/json
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_office365activationcounts"
}-->

```http
GET https://graph.microsoft.com/beta/reports/Office365ActivationCounts?$format=application/json
```
