# reportRoot: SkypeForBusinessOrganizerActivityCounts function
...
```http
GET /reports/SkypeForBusinessOrganizerActivityCounts(period='{period_value}')?$format=application/json
```
...
If successful, this method returns a `200 OK` response code and a **skypeForBusinessOrganizerActivityCounts** object in the response body.

The **skypeForBusinessOrganizerActivityCounts** object has the following properties.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_skypeforbusinessorganizeractivitycounts"
}-->

```http
GET https://graph.microsoft.com/beta/reports/SkypeForBusinessOrganizerActivityCounts(period='D7')?$format=application/json
```
