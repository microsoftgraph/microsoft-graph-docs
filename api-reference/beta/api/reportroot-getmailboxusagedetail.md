...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagedetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagedetail_json-snippets.md)]
<!--
{
