...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationcounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationcounts_json-snippets.md)]
<!--
{
