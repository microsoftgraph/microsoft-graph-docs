...
```http
GET /reports/Office365GroupsActivityCounts(period='D7')?$format=application/json
```
...
```http
GET https://graph.microsoft.com/beta/reports/Office365GroupsActivityCounts(period='D7')?$format=application/json
```
