...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusageusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusageusercounts_json-snippets.md)]
<!--
{
