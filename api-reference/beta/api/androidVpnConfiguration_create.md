...
### Response
If successful, this method returns a `201 Created` response code and a [androidVpnConfiguration](../resources/androidVpnConfiguration.md) object in the response body.
