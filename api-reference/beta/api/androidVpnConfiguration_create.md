...
Create a new [androidVpnConfiguration](../resource/androidVpnConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `201 Created` response code and a [androidVpnConfiguration](../resource/androidVpnConfiguration.md) object in the response body.
