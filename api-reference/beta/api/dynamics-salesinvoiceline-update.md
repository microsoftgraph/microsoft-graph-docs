...
```
PATCH /financials/companies('{id}')/salesInvoices('{id}')/salesInvoiceLines('{salesOrderLineId}')
```
...
```json
PATCH https://graph.microsoft.com/beta/financials/companies('{id}')/salesInvoices('{id}')/salesInvoiceLines('{salesOrderLineId}')
Content-type: application/json
