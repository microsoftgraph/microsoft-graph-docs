...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusageuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammerdeviceusageuserdetail_json-snippets.md)]
<!--
{
