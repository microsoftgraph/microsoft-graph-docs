# Get SharePointActivityUserCounts report

> **Important:** APIs under the /beta version in Microsoft Graph are in preview and are subject to change. Use of these APIs in production applications is not supported.

Get a SharePoint activity user counts report.
...
```http
GET /reports/SharePointActivityUserCounts(period='D7')
```
...
```http
GET https://graph.microsoft.com/v1.0/reports/SharePointActivityUserCounts(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.sharePointActivityUserCounts)", 
  "value": [
    {
