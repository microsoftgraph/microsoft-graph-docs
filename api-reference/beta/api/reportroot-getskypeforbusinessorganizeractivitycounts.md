...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivitycounts_json-snippets.md)]
<!--
{
