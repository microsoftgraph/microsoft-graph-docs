...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivitycounts_json-snippets.md)]
<!--
{
