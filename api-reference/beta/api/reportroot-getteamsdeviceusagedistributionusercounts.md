...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusagedistributionusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsdeviceusagedistributionusercounts_json-snippets.md)]
<!--
{
