...
Retrieve the properties and relationships of paymentmethod object.
...
If successful, this method returns a `200 OK` response code and the requested [paymentMethod](../resources/dynamics-paymentmethod.md) object in the response body.
