# Get Office365GroupsActivityStorage report
...
```http
GET https://graph.microsoft.com/v1.0/reports/Office365GroupsActivityStorage(period='D7')
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#Collection(microsoft.graph.office365GroupsActivityStorage)", 
  "value": [
    {
