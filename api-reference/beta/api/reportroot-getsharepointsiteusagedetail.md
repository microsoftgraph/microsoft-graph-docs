...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getsharepointsiteusagedetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getsharepointsiteusagedetail_json-snippets.md)]
<!--
{
