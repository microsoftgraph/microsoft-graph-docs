...
List properties and relationships of the [cloudPkiSubscription](../resources/cloudPkiSubscription.md) objects.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and a collection of [cloudPkiSubscription](../resources/cloudPkiSubscription.md) objects in the response body.
