...
Read properties and relationships of the [androidWiFiConfiguration](../resources/androidWiFiConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidWiFiConfiguration](../resources/androidWiFiConfiguration.md) object in the response body.
