...
Read properties and relationships of the [editionUpgradeConfiguration](../resource/editionUpgradeConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [editionUpgradeConfiguration](../resource/editionUpgradeConfiguration.md) object in the response body.
