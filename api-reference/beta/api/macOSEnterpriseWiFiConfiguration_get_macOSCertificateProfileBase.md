...
Get the [macOSCertificateProfileBase](macOSCertificateProfileBase.md) from the identityCertificateForClientAuthentication navigation property.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSCertificateProfileBase](../resource/macOSCertificateProfileBase.md) object in the response body.
