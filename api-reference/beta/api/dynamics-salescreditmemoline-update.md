...
```
PATCH /financials/companies('{id}')/salesCreditMemos('{id}')/salesCreditMemoLines('{salesCreditMemoLineId}')
```
...
```json
PATCH https://graph.microsoft.com/beta/financials/companies('{id}')/salesCreditMemos('{id}')/salesCreditMemoLines('{salesCreditMemoLineId}')
Content-type: application/json
