...
```http
POST /financials/companies/{id}/employees/{id}/picture
```
...
<!-- {
  "blockType": "request",
  "name": "create_picture_from_employee"
}-->

```http
POST https://graph.microsoft.com/beta/financials/companies/{id}/employees/{id}/picture
