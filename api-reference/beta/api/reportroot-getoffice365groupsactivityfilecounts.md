...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivityfilecounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivityfilecounts_json-snippets.md)]
<!--
{
