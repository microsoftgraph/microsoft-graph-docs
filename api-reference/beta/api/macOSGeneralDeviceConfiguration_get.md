...
Read properties and relationships of the [macOSGeneralDeviceConfiguration](../resource/macOSGeneralDeviceConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSGeneralDeviceConfiguration](../resource/macOSGeneralDeviceConfiguration.md) object in the response body.
