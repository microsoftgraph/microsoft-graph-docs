...
Enables you to understand the trend of the amount of email activity going on in your organization. You can understand the split of email send or read or received activities.
...
```http
GET /reports/EmailActivityCounts(period='{period_value}')?$format=application/json
```
...
```http
GET https://graph.microsoft.com/beta/reports/EmailActivityCounts(period='D7')?$format=application/json
```
