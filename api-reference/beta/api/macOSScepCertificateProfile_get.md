...
Read properties and relationships of the [macOSScepCertificateProfile](../resource/macOSScepCertificateProfile.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSScepCertificateProfile](../resource/macOSScepCertificateProfile.md) object in the response body.
