...
-->
```http
POST ** Entity URI for microsoft.management.services.api.mobileAppContentFile not found
```
...
```http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.management.services.api.mobileAppContentFile not found
