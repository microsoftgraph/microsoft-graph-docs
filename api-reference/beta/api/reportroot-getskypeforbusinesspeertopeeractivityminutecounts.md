...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivityminutecounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivityminutecounts_json-snippets.md)]
<!--
{
