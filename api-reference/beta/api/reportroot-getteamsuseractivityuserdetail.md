...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivityuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getteamsuseractivityuserdetail_json-snippets.md)]
<!--
{
