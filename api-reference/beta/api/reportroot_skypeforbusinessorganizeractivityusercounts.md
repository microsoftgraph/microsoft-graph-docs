# reportRoot: SkypeForBusinessOrganizerActivityUserCounts function
...
```http
GET /reports/SkypeForBusinessOrganizerActivityUserCounts(period='{period_value}')?$format=application/json
```
...
<!-- {
  "blockType": "request",
  "name": "reportroot_skypeforbusinessorganizeractivityusercounts"
}-->

```http
GET https://graph.microsoft.com/beta/reports/SkypeForBusinessOrganizerActivityUserCounts(period='D7')?$format=application/json
```
