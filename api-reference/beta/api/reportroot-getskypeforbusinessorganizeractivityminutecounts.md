...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivityminutecounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivityminutecounts_json-snippets.md)]
<!--
{
