...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationsuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationsuserdetail_json-snippets.md)]
<!--
{
