...
```http
GET /reports/EmailAppUsageAppsUserCounts(period='D7')?$format=application/json
```
...
```http
GET https://graph.microsoft.com/beta/reports/EmailAppUsageAppsUserCounts(period='D7')?$format=application/json
```
