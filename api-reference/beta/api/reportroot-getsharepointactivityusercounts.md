...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getsharepointactivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getsharepointactivityusercounts_json-snippets.md)]
<!--
{
