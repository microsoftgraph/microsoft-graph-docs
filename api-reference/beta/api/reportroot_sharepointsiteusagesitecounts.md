# reportRoot: SharePointSiteUsageSiteCounts function
...
```http
GET /reports/SharePointSiteUsageSiteCounts(period='{period_value}')?$format=application/json
```
...
If successful, this method returns a `200 OK` response code and a **sharePointSiteUsageSiteCounts** object in the response body.
