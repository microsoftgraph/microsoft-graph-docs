...
Create a new [deviceConfigurationDeviceStatus](../resource/deviceConfigurationDeviceStatus.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `201 Created` response code and a [deviceConfigurationDeviceStatus](../resource/deviceConfigurationDeviceStatus.md) object in the response body.
