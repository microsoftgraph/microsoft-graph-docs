...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityfilecounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityfilecounts_json-snippets.md)]
<!--
{
