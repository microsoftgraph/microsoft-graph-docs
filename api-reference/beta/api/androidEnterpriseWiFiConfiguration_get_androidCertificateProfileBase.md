...
Get the [androidCertificateProfileBase](androidCertificateProfileBase.md) from the identityCertificateForClientAuthentication navigation property.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidCertificateProfileBase](../resource/androidCertificateProfileBase.md) object in the response body.
