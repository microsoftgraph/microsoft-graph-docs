...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivityusercounts_json-snippets.md)]
<!--
{
