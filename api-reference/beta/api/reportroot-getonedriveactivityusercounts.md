...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getonedriveactivityusercounts_json-snippets.md)]
<!--
{
