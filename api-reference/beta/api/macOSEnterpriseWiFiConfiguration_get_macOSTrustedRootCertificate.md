...
Get the [macOSTrustedRootCertificate](macOSTrustedRootCertificate.md) from the rootCertificateForServerValidation navigation property.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSTrustedRootCertificate](../resource/macOSTrustedRootCertificate.md) object in the response body.
