...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinesspeertopeeractivitycounts_json-snippets.md)]
<!--
{
