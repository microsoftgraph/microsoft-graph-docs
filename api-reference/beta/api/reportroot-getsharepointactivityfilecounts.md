...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getsharepointactivityfilecounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activeusercounts_json-snippets.md)]
<!--
{
