...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activeuserdetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activeuserdetail_json-snippets.md)]
<!--
{
