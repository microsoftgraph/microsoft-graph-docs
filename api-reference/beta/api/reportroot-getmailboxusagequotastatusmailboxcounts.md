...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagequotastatusmailboxcounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagequotastatusmailboxcounts_json-snippets.md)]
<!--
{
