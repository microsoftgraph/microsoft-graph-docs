...
```http
GET /reports/YammerGroupsActivityCounts(period='{period_value}')?$format=application/json
```
...
If successful, this method returns a `200 OK` response code and a **yammerGroupsActivityCounts** object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_yammergroupsactivitycounts"
}-->
