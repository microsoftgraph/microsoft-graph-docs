...
Get the [deviceConfiguration](deviceConfiguration.md) from the deviceConfiguration navigation property.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [deviceConfiguration](../resource/deviceConfiguration.md) object in the response body.
