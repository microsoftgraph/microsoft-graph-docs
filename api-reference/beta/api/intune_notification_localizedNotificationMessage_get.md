...
-->
```http
GET /deviceManagement/notificationMessageTemplates/<id>/localizedNotificationMessages/<id>
GET /localizedNotificationMessages/<id>
```
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/notificationMessageTemplates/<id>/localizedNotificationMessages/<id>
```
