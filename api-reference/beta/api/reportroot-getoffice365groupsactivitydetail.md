...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitydetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365groupsactivitydetail_json-snippets.md)]
<!--
{
