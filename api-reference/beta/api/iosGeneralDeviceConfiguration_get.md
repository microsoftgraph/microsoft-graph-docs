...
Read properties and relationships of the [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md) object in the response body.
