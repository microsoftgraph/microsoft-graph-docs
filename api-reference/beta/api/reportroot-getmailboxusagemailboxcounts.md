...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagemailboxcounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getmailboxusagemailboxcounts_json-snippets.md)]
<!--
{
