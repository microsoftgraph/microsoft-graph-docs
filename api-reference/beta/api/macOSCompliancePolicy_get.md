...
Read properties and relationships of the [macOSCompliancePolicy](../resource/macOSCompliancePolicy.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSCompliancePolicy](../resource/macOSCompliancePolicy.md) object in the response body.
