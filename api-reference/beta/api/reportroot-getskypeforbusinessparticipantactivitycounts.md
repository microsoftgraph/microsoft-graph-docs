...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessparticipantactivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessparticipantactivitycounts_json-snippets.md)]
<!--
{
