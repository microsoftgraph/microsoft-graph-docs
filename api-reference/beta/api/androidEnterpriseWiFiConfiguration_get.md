...
Read properties and relationships of the [androidEnterpriseWiFiConfiguration](../resource/androidEnterpriseWiFiConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidEnterpriseWiFiConfiguration](../resource/androidEnterpriseWiFiConfiguration.md) object in the response body.
