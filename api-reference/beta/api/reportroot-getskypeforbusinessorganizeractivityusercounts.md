...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessorganizeractivityusercounts_json-snippets.md)]
<!--
{
