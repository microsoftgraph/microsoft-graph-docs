...
## HTTP request
```
DELETE /financials/companies('{id}')/salesCreditMemos('{id}')/salesCreditMemoLines('{salesCreditMemoLineId}')
```
...
```json
DELETE https://graph.microsoft.com/beta/financials/companies('{id}')/salesCreditMemos('{id}')/salesCreditMemoLines('{salesCreditMemoLineId}')
```
