...
Read properties and relationships of the [iosCompliancePolicy](../resource/iosCompliancePolicy.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosCompliancePolicy](../resource/iosCompliancePolicy.md) object in the response body.
