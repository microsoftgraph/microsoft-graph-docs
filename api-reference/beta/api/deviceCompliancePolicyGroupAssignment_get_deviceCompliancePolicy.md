...
Get the [deviceCompliancePolicy](deviceCompliancePolicy.md) from the deviceCompliancePolicy navigation property.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [deviceCompliancePolicy](../resource/deviceCompliancePolicy.md) object in the response body.
