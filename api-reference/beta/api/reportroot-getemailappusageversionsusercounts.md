...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailappusageversionsusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailappusageversionsusercounts_json-snippets.md)]
<!--
{
