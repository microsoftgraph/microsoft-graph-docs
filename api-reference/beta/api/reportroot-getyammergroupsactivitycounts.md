...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitycounts_json-snippets.md)]
<!--
{
