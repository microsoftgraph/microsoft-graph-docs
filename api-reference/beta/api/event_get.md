...
{
  "@odata.context":"https://graph.microsoft.com/testexchangeBeta/$metadata#users('d1a2fae9-db66-4cc9-8133-2184c77af1b8')/events(subject,body,bodyPreview,organizer,attendees,start,end,location,locations)/$entity",
  ...
  "organizer":{
    "emailAddress":{
      "name":"Adele Vance",
      "address":"AdeleV@MOD154847.onmicrosoft.com"
    }
  }
}
```
