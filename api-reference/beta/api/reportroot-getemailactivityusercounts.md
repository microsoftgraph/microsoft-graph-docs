...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getemailactivityusercounts_json-snippets.md)]
<!--
{
