...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammeractivitycounts_json-snippets.md)]
<!--
{
