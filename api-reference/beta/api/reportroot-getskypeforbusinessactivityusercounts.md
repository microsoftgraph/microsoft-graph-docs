...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessactivityusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessactivityusercounts_json-snippets.md)]
<!--
{
