...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessactivitycounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getskypeforbusinessactivitycounts_json-snippets.md)]
<!--
{
