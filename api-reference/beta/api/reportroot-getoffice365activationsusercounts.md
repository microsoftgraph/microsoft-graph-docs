...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationsusercounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getoffice365activationsusercounts_json-snippets.md)]
<!--
{
