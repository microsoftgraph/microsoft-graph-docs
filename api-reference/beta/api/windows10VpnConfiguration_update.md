...
### Request body
In the request body, supply a JSON representation of a [windows10VpnConfiguration](../resources/windows10VpnConfiguration.md) object.
The following table shows the properties that are required when you create a [windows10VpnConfiguration](../resources/windows10VpnConfiguration.md).
