# reportRoot: MailboxUsageMailboxCounts function
...
If successful, this method returns a `200 OK` response code and a **mailboxUsageMailboxCounts** object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "reportroot_mailboxusagemailboxcounts"
}-->
