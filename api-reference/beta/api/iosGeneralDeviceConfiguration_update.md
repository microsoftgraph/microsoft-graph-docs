...
Update the properties of a [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md) object.
### Prerequisites
...
### Request body
In the request body, supply a JSON representation of a [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md) object.
The following table shows the properties that are required when you create a [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md).
...
### Response
If successful, this method returns a `200 OK` response code and an updated [iosGeneralDeviceConfiguration](../resource/iosGeneralDeviceConfiguration.md) object in the response body.
