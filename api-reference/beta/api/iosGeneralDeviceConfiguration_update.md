...
### Request body
In the request body, supply a JSON representation of a [iosGeneralDeviceConfiguration](../resources/iosGeneralDeviceConfiguration.md) object.
The following table shows the properties that are required when you create a [iosGeneralDeviceConfiguration](../resources/iosGeneralDeviceConfiguration.md).
