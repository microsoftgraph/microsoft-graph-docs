...
|localesToInstall|String collection|The property to represent the locales which are installed when the apps from Office365 is installed. It uses standard RFC 6033. See [Language identifiers and OptionState Id values in Office 2016](https://docs.microsoft.com/DeployOffice/office2016/language-identifiers-and-optionstate-id-values-in-office-2016) |
