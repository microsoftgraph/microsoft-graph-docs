...
Read properties and relationships of the [iosVpnConfiguration](../resources/iosVpnConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [iosVpnConfiguration](../resources/iosVpnConfiguration.md) object in the response body.
