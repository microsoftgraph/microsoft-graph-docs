...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitydetail_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitydetail_json-snippets.md)]
<!--
{
