...
Read properties and relationships of the [androidCustomConfiguration](../resource/androidCustomConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidCustomConfiguration](../resource/androidCustomConfiguration.md) object in the response body.
