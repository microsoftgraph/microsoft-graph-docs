...

{
  ...
  "roleDefinition": {
    ...
    "description": "Manages mobile and managed applications, can read device information and can view device configuration profiles.",
    "rolePermissions": {
      "allowedResourceActions": ["//omitted for brevity"],
      "excludedResourceActions": ["//omitted for brevity"],
    },
    "isEnabled": true,
    "isBuiltIn": true,
  },
