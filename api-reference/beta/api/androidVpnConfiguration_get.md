...
Read properties and relationships of the [androidVpnConfiguration](../resource/androidVpnConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidVpnConfiguration](../resource/androidVpnConfiguration.md) object in the response body.
