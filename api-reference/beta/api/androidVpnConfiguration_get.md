...
Read properties and relationships of the [androidVpnConfiguration](../resources/androidVpnConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [androidVpnConfiguration](../resources/androidVpnConfiguration.md) object in the response body.
