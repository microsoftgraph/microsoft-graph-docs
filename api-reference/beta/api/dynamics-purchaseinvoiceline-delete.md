...
## HTTP request
```
DELETE /financials/companies('{id}')/purchaseInvoices('{id}')/purchaseInvoiceLines('{purchaseInvoiceLineId}')
```
...
```json
DELETE https://graph.microsoft.com/beta/financials/companies('{id}')/purchaseInvoices('{id}')/purchaseInvoiceLines('{purchaseInvoiceLineId}')
```
