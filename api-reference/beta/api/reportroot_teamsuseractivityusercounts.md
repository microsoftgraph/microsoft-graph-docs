# TeamsUserActivityUserCounts function
...
If successful, this method returns a `200 OK` response code and an **teamsUserActivityUserCounts** object in the response body.

The **teamsUserActivityUserCounts** object has the following properties.
