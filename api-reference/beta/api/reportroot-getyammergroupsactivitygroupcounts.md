...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitygroupcounts_csv-snippets.md)]
...
```
[!INCLUDE [Sample Code]( ../includes/reportroot_getyammergroupsactivitygroupcounts_json-snippets.md)]
<!--
{
