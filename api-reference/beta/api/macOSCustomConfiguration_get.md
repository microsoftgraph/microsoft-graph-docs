...
Read properties and relationships of the [macOSCustomConfiguration](../resource/macOSCustomConfiguration.md) object.
### Prerequisites
...
### Response
If successful, this method returns a `200 OK` response code and [macOSCustomConfiguration](../resource/macOSCustomConfiguration.md) object in the response body.
