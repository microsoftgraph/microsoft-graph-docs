# TeamsUserActivityCounts function
...
If successful, this method returns a `200 OK` response code and an **teamsUserActivityCounts** object in the response body.

The **teamsUserActivityCounts** object has the following properties.
